public class Province
{
   ...
   */
   ...
   //
   public Province (String nam, int pop, double ar){
    name = nam;
    population = pop;
    area = ar;
   ...
   */
   ...
   public int compareDensity (Province other){
      if (this.getPopulationDensity() > other.getPopulationDensity()){
         return 1;
      }
      else if (this.getPopulationDensity() < other.getPopulationDensity()){
         return -1;
      }
      else {
         return 0;
